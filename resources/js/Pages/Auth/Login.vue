...
-->
    ...
    <section class="min-h-screen flex items-center justify-center ">
        <div class="bg-white rounded-lg shadow-lg p-8 max-w-xl w-2/3">
            <!-- Card Heading -->
            <h2 class="text-2xl font-semibold text-gray-900 text-center mb-6">Enter details below to create an account
            </h2>
